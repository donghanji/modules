...
module.exports=function(grunt){
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            zepto:{
                src: ['src/zepto/zepto.module.start.js','libs/zepto/src/zepto.js','libs/zepto/src/event.js','libs/zepto/src/callbacks.js','libs/zepto/src/ajax.js','libs/zepto/src/form.js','libs/zepto/src/fx.js','libs/zepto/src/fx_methods.js','libs/zepto/src/assets.js','libs/zepto/src/data.js','libs/zepto/src/selector.js','src/zepto/touch.js','src/zepto/zepto.module.end.js'],//
